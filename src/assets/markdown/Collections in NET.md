...
<details>
    <summary>The different type of data structure available in C# are:</summary>
...
LinkedList has disadvantage in case of indexing as the node cannot be retrieved as easily as it can be for arrays and list.
